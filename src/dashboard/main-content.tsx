...
import { DeploymentsContent } from "./contents/deployments-content";
...
const sectionConfig: Record<Section, { title: string; subtitle: string }> = {
  ...
  incidents: { title: "Incidents", subtitle: "Active & Recent Incidents" },
  deployments: { title: "Deployments", subtitle: "Release Pipeline & History" },
  performance: { title: "Performance", subtitle: "System Latency & Throughput" },
  errors: { title: "Error Tracking", subtitle: "Exceptions & Error Rates" },
  sla: { title: "SLA & Uptime", subtitle: "Service Level Monitoring" },
  oncall: { title: "On-Call", subtitle: "Schedule & Response Metrics" },
  services: { title: "Services", subtitle: "Service Catalog & Health" },
...
export function MainContent({ activeSection }: MainContentProps) {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "deployments": return <DeploymentsContent />;
